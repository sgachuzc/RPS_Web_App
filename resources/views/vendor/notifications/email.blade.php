                                ...
                                <tr>
                                    <td class="content-cell" style="max-width: 100vw; padding: 32px;">
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $actionUrl }}" class="button button-primary" target="_blank" rel="noopener" style="border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #A91D3A; border-bottom: 8px solid #A91D3A; border-left: 18px solid #A91D3A; border-right: 18px solid #A91D3A; border-top: 8px solid #A91D3A; word-break: break-all;">Restablecer contraseña</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="border-top: 1px solid #fff; margin-top: 25px; padding-top: 25px;">
                                            <tr>
                                                <td>
                                                    <p style="line-height: 1.5em; margin-top: 0; text-align: left; font-size: 14px;">Si tiene problemas para hacer clic en el botón "Restablecer contraseña", copie y pegue la siguiente URL en su navegador web: <span class="break-all"><a href="{{ $actionUrl }}" style="color: #C73659; word-break: break-all;">{{ $actionUrl }}</a></span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
