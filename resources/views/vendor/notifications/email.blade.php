                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $actionUrl }}" class="button button-primary" target="_blank" rel="noopener" style="border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #007642; border-bottom: 8px solid #007642; border-left: 18px solid #007642; border-right: 18px solid #007642; border-top: 8px solid #007642; word-break: break-all;">Restablecer contraseña</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
