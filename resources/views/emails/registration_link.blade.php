                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #ffffff; border-color: #fff; border-radius: 2px; border-width: 1px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); margin: 0 auto; padding: 0; width: 570px;">
                                ...
                                <tr>
                                    <td class="content-cell" style="max-width: 100vw; padding: 32px;">
                                        ...
                                        <p style="font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Comparte a tus participantes el correo o el enlace para su inscripción</p>
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                    <tr>
                                                                        <td>
                                                                            <a href="{{ $url }}" class="button button-primary" target="_blank" rel="noopener" style="border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #A91D3A; border-bottom: 8px solid #A91D3A; border-left: 18px solid #A91D3A; border-right: 18px solid #A91D3A; border-top: 8px solid #A91D3A; word-break: break-all;">Registrate aquí</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="border-top: 1px solid #fff; margin-top: 25px; padding-top: 25px;">
                                            <tr>
                                                <td>
                                                    <p style="line-height: 1.5em; margin-top: 0; text-align: left; font-size: 14px;">Si tiene problemas para hacer clic en el botón "Registrate aquí", copie y pegue la siguiente URL en su navegador web: <span class="break-all"><a href="{{ $url }}" style="color: #C73659; word-break: break-all;">{{ $url }}</a></span></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
